...
Ejecutar exactamente igual que el modo `evaluate` (leer `modes/evaluate.md` para todos los bloques A-F).

## Paso 2 — Guardar Report .md
Guardar la evaluación completa en `reports/{###}-{company-slug}-{YYYY-MM-DD}.md` (ver formato en `modes/evaluate.md`).
